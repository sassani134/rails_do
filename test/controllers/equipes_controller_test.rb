...
class EquipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipe" do
    assert_difference("Equipe.count") do
      post equipes_url, params: { equipe: { joueur_id: @equipe.joueur_id, name: @equipe.name, town: @equipe.town } }
    end
  ...
  test "should update equipe" do
    patch equipe_url(@equipe), params: { equipe: { joueur_id: @equipe.joueur_id, name: @equipe.name, town: @equipe.town } }
